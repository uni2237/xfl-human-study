 ...
 *             ipos += nbytes
 */
        __pyx_t_17 = (__pyx_v_ipos + __pyx_v_i);
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_inbuff.shape[0];
        __pyx_t_18 = __pyx_v_rpos;
...
static __Pyx_memviewslice __pyx_f_6pandas_2io_3sas_4_sas_rdc_decompress(int __pyx_v_result_length, __Pyx_memviewslice __pyx_v_inbuff) {
  ...
  __pyx_t_6pandas_2io_3sas_4_sas_uint16_t __pyx_t_11;
  __pyx_t_6pandas_2io_3sas_4_sas_uint16_t __pyx_t_12;
  int __pyx_t_13;
  Py_ssize_t __pyx_t_14;
  Py_ssize_t __pyx_t_15;
  Py_ssize_t __pyx_t_16;
 ...
 */
        __pyx_t_10 = __pyx_v_ipos;
        if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_inbuff.shape[0];
        __pyx_t_14 = (__pyx_v_rpos + __pyx_v_k);
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_outbuff.shape[0];
 ...
 */
        __pyx_t_10 = __pyx_v_ipos;
        if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_inbuff.shape[0];
        __pyx_t_15 = (__pyx_v_rpos + __pyx_v_k);
        if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_outbuff.shape[0];
 ...
 * 
 */
        __pyx_t_10 = ((__pyx_v_rpos - ((int)__pyx_v_ofs)) + __pyx_v_k);
        if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_outbuff.shape[0];
        __pyx_t_16 = (__pyx_v_rpos + __pyx_v_k);
        if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_outbuff.shape[0];
...
static void __pyx_f_6pandas_2io_3sas_4_sas_6Parser_process_byte_array_with_data(struct __pyx_obj_6pandas_2io_3sas_4_sas_Parser *__pyx_v_self, int __pyx_v_offset, int __pyx_v_length) {
  ...
  Py_ssize_t __pyx_t_15;
  Py_ssize_t __pyx_t_16;
  __pyx_t_6pandas_2io_3sas_4_sas_int64_t __pyx_t_17;
  __pyx_t_6pandas_2io_3sas_4_sas_int64_t __pyx_t_18;
  int __pyx_t_19;
 ...
 */
        __pyx_t_20 = (__pyx_v_start + __pyx_v_k);
        if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_source.shape[0];
        __pyx_t_16 = __pyx_v_jb;
        __pyx_t_21 = (__pyx_v_m + __pyx_v_k);
        if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_byte_chunk.shape[0];
        if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_byte_chunk.shape[1];
 ...
 */
    ...
    if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_column_types.shape[0];
 ...
 */
      ...
      __pyx_t_24 = __pyx_v_current_row;
      if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_string_chunk.shape[0];
      if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_string_chunk.shape[1];
      __pyx_t_25 = ((PyObject * *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_string_chunk.data + __pyx_t_22 * __pyx_v_string_chunk.strides[0]) ) + __pyx_t_24 * __pyx_v_string_chunk.strides[1]) ));
